...
| Status | Priority | Feature | Task | Main Doc | Updated | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| Planned | P1 | channels | steering prompt config and defaults | [2026-04-12-steering-prompt-config-and-defaults.md](features/channels/2026-04-12-steering-prompt-config-and-defaults.md) | 2026-04-12 | Make auto-steered prompt injection configurable, shorten the wrapper format, and likely disable the extra steering prompt by default. |
...
| Planned | P0 | stability | tmux submit truthfulness and Telegram send reliability | [2026-04-12-tmux-submit-truthfulness-and-telegram-send-reliability.md](features/stability/2026-04-12-tmux-submit-truthfulness-and-telegram-send-reliability.md) | 2026-04-12 | Investigate reports that Telegram especially can accept a message while the tmux prompt never really submits on the first try, without fixing it through blind duplicate resend. |
