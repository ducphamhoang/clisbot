...
The `0.1.44` config migration optimizes for low-friction upgrade: when clisbot first reads a released `0.1.43` config, it backs up the original file and writes the new canonical shape automatically.
