...
Plans:
- [x] 08-01-PLAN.md — Wave 1: RED test scaffold for setup router (3 failing tests for ROUTER-01/02/03) + runSetupRouter stub
- [x] 08-02-PLAN.md — Wave 2: implement setup-router.ts + register setup in cli.ts + wire handler in main.ts (GREEN)
- [x] 08-03-PLAN.md — Wave 3: full bun run check gate + human integration checkpoint + ROADMAP update
